...
struct SwapCreate: Decodable, Hashable, Encodable {
    let wallet: String
    let asset: String
    ...
    init(wallet: String, asset: String, refund_address: String, amount: Int, direction: String, feerate: Bool, feerate_value: Int) {
        self.wallet = wallet
        self.asset = asset
...
struct SwapCreateResponse: Decodable, Hashable, Encodable, Identifiable {
    let id: String
    let wallet: String
    let asset: String
    let amount: Int
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case bip21 = "bip21"
        case redeem_script = "redeeem_script"
        case blinding_key = "blinding_key"
    }
